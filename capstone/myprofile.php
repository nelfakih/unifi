...
<div style="text-align: center;">
 <button type="submit" class="buttonlog" onclick = "window.location.href='home.html';" style="font-size: 20px; padding: 10px 0px; width:200px; margin: auto; ">Sign Out</button>
</div>
